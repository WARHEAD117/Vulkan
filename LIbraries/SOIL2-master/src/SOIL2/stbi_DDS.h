...
extern void    *stbi__dds_load_from_path   (const char *filename,           int *x, int *y, int* faces, int* mips, int *comp, int req_comp);
extern void    *stbi__dds_load_from_memory (stbi_uc const *buffer, int len, int *x, int *y, int* faces, int* mips, int *comp, int req_comp);
extern void    *stbi__dds_load_from_callbacks (stbi_io_callbacks const *clbk, void *user, int *x, int *y, int* faces, int* mips, int *comp, int req_comp);
